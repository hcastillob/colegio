	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="form form-horizontal">
				<div class="form-group has-success">
					<label for="idalumno" class="col-md-2">C&oacute;digo:</label>
					<div class="col-md-10">
						<p>{{$alumno->idalumno}}</p>
					</div>
					<label for="idgrado" class="col-md-2">Grado:</label>
					<div class="col-md-10">
						<p>{{$alumno->grado}}</p>
					</div>
					<label for="idseccion" class="col-md-2">Secci&oacute;n:</label>
					<div class="col-md-10">
						<p>{{$alumno->seccion}}</p>
					</div>
					<label for="idnivel" class="col-md-2">Nivel:</label>
					<div class="col-md-10">
						<p>{{$alumno->nivel}}</p>
					</div>
					<label for="idpadre" class="col-md-2">C&oacute;digo de padre:</label>
					<div class="col-md-10">
						<p>{{$alumno->idpadre}}</p>
					</div>
				</div>
